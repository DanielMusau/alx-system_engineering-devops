...
Project aims to teach about how to design a Web Infrastructure.
...
| `3-scale_up` | Web Infrasturcture Design, based on `2-secured_and_monitored_web_infrastructure` that contains some additional components: 1 server, 1 load-balancer.|
